...
struct DirectTestRunner {
    ...
    static func testIntradayAndAlias() throws {
        ...
        expect(ChinaTradingSession.minuteOffset(for: "13:00") == 120, "Afternoon open")
        expect(ChinaTradingSession.minuteOffset(for: "15:00") == 240, "Axis end")
        expect(ChinaTradingSession.tradingDuration == 240, "Compressed trading duration")
        expect(ChinaTradingSession.minuteOffset(for: "12:00") == nil, "Lunch break excluded")
